...
const HealthDataSync: React.FC<HealthDataSyncProps> = ({
  ...
  const platformDetail = isIOS
    ...
    : t('healthSync.connectDetail', {
        defaultValue:
          'qla.fit reads the health data you select below using Health Connect. If sync is enabled, data is synchronized only between your device and your self-hosted qla.fit server (manual or background).',
      });
